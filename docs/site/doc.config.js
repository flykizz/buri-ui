...
export const github = 'https://github.com/youzan/buri';

export default {
  'zh-CN': {
    header: {
      logo: {
        image: 'https://b.yzcdn.cn/buri/logo-white.png',
        title: 'Buri',
        href: '#/'
      },
      nav: {
        ...
        logoLink: [
          {
            image: 'https://b.yzcdn.cn/buri/logo/weapp.svg',
            url: '/buri-weapp'
          },
          {
            image: 'https://b.yzcdn.cn/buri/logo/github.svg',
            url: github
          }
        ]
      }
