<template>
  <section class="buridoc-demo-pages">
    <h1>示例工程</h1>
    ...
    <div class="card">
      ...
      <p>
        ...
        <a
          href="https://github.com/youzan/buri-demo"
          target="_blank"
        >Buri Demo</a>，示例工程会帮助你了解如下内容：
      </p>
      <ul>
        <li>基于 Buri 搭建单页面应用，配置按需引入组件</li>
    ...
    <div class="card">
      <h3>示例页面</h3>
      <p>下面是一些使用 Buri 搭建的示例页面，点击图片切换至对应示例。</p>
      <div class="buridoc-demo-pages__gallery">
        <div
          :class="['buridoc-demo-pages__item', { 'buridoc-demo-pages__item--active': index === currentDemo }]"
      ...
      return [
        {
          ...
          url: '/buri-demo/#/goods',
          source:
            'https://github.com/youzan/buri-demo/blob/master/base/src/view/goods/index.vue'
        },
        {
          title: '用户中心',
          preview:
          ...
          url: '/buri-demo/#/user',
          source:
            'https://github.com/youzan/buri-demo/blob/master/base/src/view/user/index.vue'
        },
        {
          title: '购物车',
          preview:
          ...
          url: '/buri-demo/#/cart',
          source:
            'https://github.com/youzan/buri-demo/blob/master/base/src/view/cart/index.vue'
        }
      ];
    }
  },
