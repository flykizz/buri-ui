<template>
  <div class="buri-doc">
    ...
    />
    <buri-doc-nav :base="base" :nav-config="config.nav" />
    <buri-doc-container :has-simulator="!!(simulator || simulators.length)">
      <buri-doc-content>
        <slot />
      </buri-doc-content>
    </buri-doc-container>
    <buri-doc-simulator v-if="simulator" :src="simulator" />
    <buri-doc-simulator
