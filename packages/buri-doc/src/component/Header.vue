  ...
  <div class="buri-doc-header">
    <div class="buri-doc-row">
      <div class="buri-doc-header__top">
        <a class="buri-doc-header__logo" :href="config.logo.href">
        ...
        <ul class="buri-doc-header__top-nav">
          <li v-for="item in config.nav.logoLink" class="buri-doc-header__top-nav-item">
          ...
          <li v-if="config.nav.lang" class="buri-doc-header__top-nav-item">
            <a class="buri-doc-header__cube" :href="langLink">{{ config.nav.lang.text }}</a>
          </li>
        </ul>
      </div>
    </div>
