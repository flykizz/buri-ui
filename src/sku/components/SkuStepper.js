...
export default createComponent({
  ...
  render() {
    return (
      <div class="buri-sku-stepper-stock">
        <div class="buri-sku-stepper-container">
          <div class="buri-sku__stepper-title">{this.stepperTitle || t('num')}</div>
          <Stepper
            vModel={this.currentNum}
            class="buri-sku__stepper"
          ...
          />
          {!this.hideQuotaText && this.quotaText && <span class="buri-sku__stepper-quota">({this.quotaText})</span>}
        </div>
      </div>
    );
  }
